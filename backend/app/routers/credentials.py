...
def get_one(
    ...
    return credential_service.get_credential(db, cred_id)
...
def update(
    ...
    return credential_service.update_credential(db, cred_id, data)
...
def delete(
    ...
    credential_service.delete_credential(db, cred_id)
...
def test_connection(
    ...
    cred = credential_service.test_connectivity(db, cred_id)
